function navbar (){
    ...
    <img src="https://online.kfc.co.in/static/media/kfcLogo.492728c6.svg" alt="error" >
    <a href="#" class="RPsp"> <p>Menu</p> </a>
    <a href="#"> <p>Deals</p> </a>
   </div>
   ...
   <div id="RPrightnav">
       ...
       <a href="#"> <p class="RPpad" id="RPaus">Sign up</p> </a>
       <p class="RPpad" id="RPline"> | </p>
       <h6 id="RPcartvalue">0</h6>
