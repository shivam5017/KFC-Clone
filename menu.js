...
let chickenBucket= (data)=>{
    ...
    data.forEach((ele) =>{
        if(ele.category == 'chicken buckets'){
            ...
            Image.setAttribute('class','ninja_product-img')
            Image.src=ele.Image
        
            let name = document.createElement("h4");
            name.setAttribute('class','ninja_product-name')
            name.textContent = ele.name
        
            let logo = document.createElement('img');
            logo.setAttribute('class','ninja_product-logo')
            logo.src = ele.logo;

            let serves = document.createElement('p');
            serves.setAttribute('class','ninja_product-serves')
            serves.textContent = ele.serves;

            let serve_div=document.createElement('div');
            serve_div.setAttribute('class','ninja_serve-div');
            serve_div.append(logo,serves);
        
            let price = document.createElement('h3');
            price.setAttribute('class','ninja_product-price')
            price.textContent = ele.price;

            let offerPrice = document.createElement('h3');
            offerPrice.setAttribute('class','ninja_product-offerprice')
            offerPrice.textContent = ele.offerprice;
            
            let price_div=document.createElement('div');
            price_div.setAttribute('class','ninja_price-div');
            price_div.append(price,offerPrice);

            let discripation = document.createElement('p');
            discripation.setAttribute('class','ninja_product-discripation')
            discripation.textContent = ele.discripation;
